...
- graph search: `shared/tools/local_note_search.py` or `~/.codex/tools/local_note_search.py`
- semantic search: `shared/tools/local_note_semantic_search.py` and `~/.codex/tools/local_note_semantic_search.py`
...
Codex-local owned:
- `~/.codex/tools/local_note_semantic_search.py`
- `~/.codex/skills/note-search/SKILL.md`
